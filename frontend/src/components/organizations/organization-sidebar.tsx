  ...
  return (
    <aside className="w-[280px] h-full flex-shrink-0 bg-[#1C1F37] flex flex-col z-20 py-6 text-[#8F96AE] stylish-scrollbar overflow-y-auto">
      ...
      <div className="px-6 mb-8">
        ...
        <div className="flex items-center justify-between bg-white/5 hover:bg-white/10 transition-colors px-4 py-2.5 rounded-xl cursor-pointer border border-white/5">
          <span className="font-medium text-white text-sm">SNEC Organization</span>
